...
import sys
sys.path.insert(0, '/home/duynam/turtlebot_ws/src/turtlebot3_nav_q_feedback/scripts')
    ...
    try:
        ...
        while not rospy.is_shutdown():
            ...
            if scan_time > MIN_TIME_BETWEEN_SCANS:
                ...
                plt.axis('equal')
                ax.plot(x_horizon, y_horizon, 'r:', markersize = 8, label = 'obstacles')
                ax.plot(0, 0, 'bo', markersize = 20, label = 'robot')
